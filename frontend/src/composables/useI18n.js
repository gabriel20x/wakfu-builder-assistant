...
const translations = {
  es: {
    ...
    'nav.characters': 'Mis PJ',
    'nav.metadata': 'Metadatos de Items',

    // My Characters
    'characters.title': 'Mis Personajes',
    'characters.new': 'Nuevo PJ',
    'characters.defaultName': 'Personaje',
    'characters.empty': 'Aún no tienes personajes. Crea uno e importa tu código de características desde el juego.',
    'characters.name': 'Nombre',
    'characters.class': 'Clase',
    'characters.noClass': 'Sin clase',
    'characters.level': 'Nivel',
    'characters.code': 'Código de características',
    'characters.codePlaceholder': '16:10-1:33-2:1-...',
    'characters.codeHelp': 'Pega aquí el código que copia el juego desde el panel de características.',
    'characters.import': 'Importar',
    'characters.copyCode': 'Copiar código',
    'characters.codeCopied': 'Código copiado',
    'characters.codeInvalid': 'El código no es válido. Verifica que lo copiaste completo desde el juego.',
    'characters.codeImported': 'Características importadas correctamente',
    'characters.levelAdjusted': 'Nivel ajustado',
    'characters.levelAdjustedDetail': 'El nivel se subió a {level} para cubrir los puntos gastados del código.',
    'characters.remaining': 'Restantes',
    'characters.reset': 'Reiniciar las características',
    'characters.resetConfirm': '¿Quieres poner todos los puntos a cero?',
    'characters.useInBuilder': 'Usar en el generador',
    'characters.deleteConfirm': '¿Eliminar este personaje?',
    'characters.selectPrompt': 'Selecciona un personaje o crea uno nuevo para editar sus características.',
    'characters.bonusTitle': 'Bonos de características',
    ...
    'charac.section.strength': 'Fuerza',
    'charac.section.agility': 'Agilidad',
    'charac.section.chance': 'Suerte',
    'charac.section.major': 'Mayor',
    'charac.percentHp': '% de puntos de vida',
    'charac.elementalRes': 'Resistencia elemental',
    'charac.barrier': 'Parapeto',
    'charac.healsReceived': '% de curas recibidas',
    'charac.armorHp': '% de puntos de vida en armadura',
    'charac.elementalMastery': 'Dominio elemental',
    'charac.meleeMastery': 'Dominio de melé',
    'charac.distanceMastery': 'Dominio distancia',
    'charac.hp': 'Puntos de vida',
    'charac.lock': 'Placaje',
    'charac.dodge': 'Esquiva',
    'charac.initiative': 'Iniciativa',
    'charac.lockAndDodge': 'Placaje y esquiva',
    'charac.forceOfWill': 'Voluntad',
    'charac.criticalHit': '% de golpe crítico',
    'charac.block': '% de anticipación',
    'charac.criticalMastery': 'Dominio crítico',
    'charac.rearMastery': 'Dominio espalda',
    'charac.berserkMastery': 'Dominio berserker (PdV < 50%)',
    'charac.healingMastery': 'Dominio cura',
    'charac.rearResistance': 'Resistencia por la espalda',
    'charac.criticalResistance': 'Resistencia crítica',
    'charac.majorAp': 'Puntos de acción',
    'charac.majorMp': 'Puntos de movimiento y daños',
    'charac.majorRange': 'Alcance y daños',
    'charac.majorWp': 'Punto de Wakfu',
    'charac.majorArmorGiven': '% de armadura dada',
    'charac.majorDamageInflicted': '% de daños infligidos',
    'charac.majorRes': 'Resistencia elemental',
    'charac.majorHealsPerformed': '% de curas realizadas',
    'charac.majorIndirectDamage': '% de daños indirectos',
  ...
  en: {
    ...
    'characters.defaultName': 'Character',
    'characters.empty': 'No characters yet. Create one and import your characteristics code from the game.',
    'characters.name': 'Name',
    'characters.class': 'Class',
    'characters.noClass': 'No class',
    'characters.level': 'Level',
    'characters.code': 'Characteristics code',
    'characters.codePlaceholder': '16:10-1:33-2:1-...',
    'characters.codeHelp': 'Paste the code the game copies from the characteristics panel.',
    'characters.import': 'Import',
    'characters.copyCode': 'Copy code',
    'characters.codeCopied': 'Code copied',
    'characters.codeInvalid': 'Invalid code. Make sure you copied it completely from the game.',
    'characters.codeImported': 'Characteristics imported successfully',
    'characters.levelAdjusted': 'Level adjusted',
    'characters.levelAdjustedDetail': 'Level was raised to {level} to cover the points spent in the code.',
    'characters.remaining': 'Remaining',
    'characters.reset': 'Reset characteristics',
    'characters.resetConfirm': 'Set all points back to zero?',
    'characters.useInBuilder': 'Use in generator',
    'characters.deleteConfirm': 'Delete this character?',
    'characters.selectPrompt': 'Select a character or create a new one to edit its characteristics.',
    'characters.bonusTitle': 'Characteristics bonuses',
    ...
    'charac.section.strength': 'Strength',
    'charac.section.agility': 'Agility',
    'charac.section.chance': 'Chance',
    'charac.section.major': 'Major',
    'charac.percentHp': '% Health Points',
    'charac.elementalRes': 'Elemental Resistance',
    'charac.barrier': 'Barrier',
    'charac.healsReceived': '% Heals Received',
    'charac.armorHp': '% Health Points as Armor',
    'charac.elementalMastery': 'Elemental Mastery',
    'charac.meleeMastery': 'Melee Mastery',
    'charac.distanceMastery': 'Distance Mastery',
    'charac.hp': 'Health Points',
    'charac.lock': 'Lock',
    'charac.dodge': 'Dodge',
    'charac.initiative': 'Initiative',
    'charac.lockAndDodge': 'Lock and Dodge',
    'charac.forceOfWill': 'Force of Will',
    'charac.criticalHit': '% Critical Hit',
    'charac.block': '% Block',
    'charac.criticalMastery': 'Critical Mastery',
    'charac.rearMastery': 'Rear Mastery',
    'charac.berserkMastery': 'Berserk Mastery (HP < 50%)',
    'charac.healingMastery': 'Healing Mastery',
    'charac.rearResistance': 'Rear Resistance',
    'charac.criticalResistance': 'Critical Resistance',
    'charac.majorAp': 'Action Points',
    'charac.majorMp': 'Movement Points and Damage',
    'charac.majorRange': 'Range and Damage',
    'charac.majorWp': 'Wakfu Points',
    'charac.majorArmorGiven': '% Armor Given',
    'charac.majorDamageInflicted': '% Damage Inflicted',
    'charac.majorRes': 'Elemental Resistance',
    'charac.majorHealsPerformed': '% Heals Performed',
    'charac.majorIndirectDamage': '% Indirect Damage',
  ...
  fr: {
    ...
    'nav.characters': 'Mes Persos',
    'nav.metadata': 'Métadonnées d\'Items',

    // Mes Personnages
    'characters.title': 'Mes Personnages',
    'characters.new': 'Nouveau perso',
    'characters.defaultName': 'Personnage',
    'characters.empty': 'Pas encore de personnages. Crée-en un et importe ton code de caractéristiques depuis le jeu.',
    'characters.name': 'Nom',
    'characters.class': 'Classe',
    'characters.noClass': 'Sans classe',
    'characters.level': 'Niveau',
    'characters.code': 'Code de caractéristiques',
    'characters.codePlaceholder': '16:10-1:33-2:1-...',
    'characters.codeHelp': 'Colle ici le code que le jeu copie depuis le panneau de caractéristiques.',
    'characters.import': 'Importer',
    'characters.copyCode': 'Copier le code',
    'characters.codeCopied': 'Code copié',
    'characters.codeInvalid': 'Code invalide. Vérifie que tu l\'as copié en entier depuis le jeu.',
    'characters.codeImported': 'Caractéristiques importées avec succès',
    'characters.levelAdjusted': 'Niveau ajusté',
    'characters.levelAdjustedDetail': 'Le niveau a été monté à {level} pour couvrir les points dépensés du code.',
    'characters.remaining': 'Restants',
    'characters.reset': 'Réinitialiser les caractéristiques',
    'characters.resetConfirm': 'Remettre tous les points à zéro ?',
    'characters.useInBuilder': 'Utiliser dans le générateur',
    'characters.deleteConfirm': 'Supprimer ce personnage ?',
    'characters.selectPrompt': 'Sélectionne un personnage ou crées-en un nouveau pour éditer ses caractéristiques.',
    'characters.bonusTitle': 'Bonus des caractéristiques',
    ...
    'charac.section.intelligence': 'Intelligence',
    'charac.section.strength': 'Force',
    'charac.section.agility': 'Agilité',
    'charac.section.chance': 'Chance',
    'charac.section.major': 'Majeur',
    'charac.percentHp': '% de points de vie',
    'charac.elementalRes': 'Résistance élémentaire',
    'charac.barrier': 'Barrière',
    'charac.healsReceived': '% de soins reçus',
    'charac.armorHp': '% de points de vie en armure',
    'charac.elementalMastery': 'Maîtrise élémentaire',
    'charac.meleeMastery': 'Maîtrise mêlée',
    'charac.distanceMastery': 'Maîtrise distance',
    'charac.hp': 'Points de vie',
    'charac.lock': 'Tacle',
    'charac.dodge': 'Esquive',
    'charac.initiative': 'Initiative',
    'charac.lockAndDodge': 'Tacle et esquive',
    'charac.forceOfWill': 'Volonté',
    'charac.criticalHit': '% de coup critique',
    'charac.block': '% de parade',
    'charac.criticalMastery': 'Maîtrise critique',
    'charac.rearMastery': 'Maîtrise dos',
    'charac.berserkMastery': 'Maîtrise berserk (PdV < 50%)',
    'charac.healingMastery': 'Maîtrise soin',
    'charac.rearResistance': 'Résistance dos',
    'charac.criticalResistance': 'Résistance critique',
    'charac.majorAp': 'Points d\'action',
    'charac.majorMp': 'Points de mouvement et dégâts',
    'charac.majorRange': 'Portée et dégâts',
    'charac.majorWp': 'Points de Wakfu',
    'charac.majorArmorGiven': '% d\'armure donnée',
    'charac.majorDamageInflicted': '% de dégâts infligés',
    'charac.majorRes': 'Résistance élémentaire',
    'charac.majorHealsPerformed': '% de soins réalisés',
    'charac.majorIndirectDamage': '% de dégâts indirects',
